        ...
        <form className="flex flex-col gap-6" onSubmit={onSubmit} ref={formRef}>
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-2">
              ...
              <input className={inputClass} placeholder="Tu nombre" required type="text" />
            </div>
            <div className="flex flex-col gap-2">
              <FieldLabel>Empresa</FieldLabel>
              <input className={inputClass} placeholder="Tu empresa" type="text" />
            </div>
          </div>
          <div className="flex flex-col gap-2">
            <FieldLabel>Email</FieldLabel>
            <input className={inputClass} placeholder="tu@email.com" required type="email" />
          </div>
          <div className="flex flex-col gap-2">
            ...
            <select className={inputClass}>
              ...
              <option className="bg-rubric-black">No sé bien, quiero hablar</option>
            </select>
          </div>
          <div className="flex flex-col gap-2">
          ...
          <button
            className={`self-start rounded-none border-0 px-10 py-[1.1rem] font-sans text-[0.85rem] font-medium tracking-[0.15em] text-rubric-white uppercase transition-colors duration-200 ${
              submitted ? "bg-[#2c5f2d]" : "bg-rubric-red hover:bg-rubric-red-dark"
            }`}
            type="submit">
